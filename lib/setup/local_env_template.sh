...
# This should point to the miner_retraining_data directory in google drive. 
# EXTERNAL_NAMES=("google_drive")
# EXTERNAL_PATHS=("/Users/username/MyGoogleDrive/data_path_to_specific_project")
