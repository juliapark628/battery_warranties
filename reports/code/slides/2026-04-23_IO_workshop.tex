...
\begin{itemize}
    ...
    \item \textit{Annual throughput cap} equivalent to 365 cycles
    \item \textit{SOC ceiling ($<50\%$)}
    \item \textit{SOC floor ($>51\%$)}
\end{itemize}
...
\begin{itemize}
    \item In the future: compare to socially-optimal dispatch? (peak load reduction, emission reduction)
\end{itemize}
